            ...
            <div id="verifiedToast" class="toast align-items-center text-white border-0" role="alert"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="toast-body">
                        <i class="bi bi-check-circle-fill fs-4 me-2"></i> {{ session('status') }}
                    </div>
                        ...
                        <table class="table table-bordered table-striped mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center" style="width: 5%;"> IDR
                                        {{ number_format($po->harga_tebus, 0, ',', '.') }}</td>
                                    <td align="center" style="width: 5%;">IDR 0</td>
                                    <td align="center" style="width: 5%;">{{ $po->kd_tax }}</td>
                                    <td align="right" style="width: 15%;">
                                        IDR {{ number_format($po->volume_po * $po->harga_tebus, 0, ',', '.') }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="table-responsive">
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tr>
                                        <th class="text-muted">PPN 11/12</th>
                                        <td class="text-end">
