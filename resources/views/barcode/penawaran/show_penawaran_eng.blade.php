...
<div class="max-w-3xl mx-auto bg-white p-6 sm:p-8 rounded-lg shadow-lg">
        ...
        <div class="flex justify-end mb-2">
            <div class="inline-flex items-center text-green-700 font-semibold text-sm rounded-full px-4 py-2">
            ...
            <div class="text-xs sm:text-sm text-gray-700 mb-4">
               ...
               <div class="mb-6 text-xs sm:text-sm text-black">
                ...
                <p class="text-center text-xs sm:text-sm mt-5">Price Quotation of {{ $data->merk_dagang }}</p>
                        <p class="text-justify text-xs sm:text-sm mt-5">Dear sir, </p>
                        <p class="text-justify text-xs sm:text-sm mt-5">Within this letter, our company PT Pro Energi is a regulated entity commercial and has fuel permit from ESDM, which engaged in Fuel Oil</p>
                        <p class="text-justify text-xs sm:text-sm mt-5 mb-5">From our experiences, trustworthy product, and resources, believed that we can fulfill the oil needs for your
                        company {{ $data->nama_customer }}. Based on above, we are pleased to quote as follows: {{ $data->gelar }}:</p>
                        ...
                        <table class="w-full text-xs sm:text-sm bg-white">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="pl-5 w-1/3 align-top">Product</td>
                                ...
                                <tr >
                                    ...
                                    <td class="pl-5 align-top">Price per Liter </td>
                                    <td class="align-top">
                                ...
                                <tr>
                                    ...
                                    <td class="pl-5">Payment term</td>
                                    <td>: <strong>{{ $arrPayment[$data->jenis_payment] }}</strong></td>
                                </tr>
                                <tr>
                                    <td class=" text-right ">5. </td>
                                    <td class="pl-5">Order Method</td>
                                    <td>: Order placed <strong>{{ $data->method_order }} days</strong> prior to delivery date</td>
                                </tr>
                                <tr>
                                    <td class=" text-right ">6. </td>
                                    <td class="pl-5">Supply</td>
                                    <td>: Product will be delivered after PO confirmation</div>
                                </tr>
                                <tr>
                                    <td class=" text-right ">7. </td>
                                    <td class="pl-5">Price due to</td>
                                    <td>: <strong>  {{ \Carbon\Carbon::parse($data->masa_awal)->format('d F Y') . " s/d " . \Carbon\Carbon::parse($data->masa_akhir)->format('d F Y')}}</div></strong></td>
                                </tr>
                                <tr>
                                    <td class="text-right">8. </td>
                                    <td class="pl-5">Tolerance</td>
                                    <td>: {{ $data->tol_susut }} % from total delivery based on Flowmeter Pro Energi</div></strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                 
                        <p class="text-justify mt-5 mb-5 text-xs sm:text-sm" >Hopefully we can get the opportunity and trust from you to do the good business relationship with your company.
                            Thank you for your attention and cooperation</p><br />
